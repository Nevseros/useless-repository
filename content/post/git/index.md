...
subtitle: Системы контроля версий используют практически во всех сферах IT. Давайте узнаем про них чуть больше.

# Summary for listings and search engines
summary: Системы контроля версий используют практически во всех сферах IT. Давайте узнаем про них чуть больше.
...
Так же ваши репозитории можно хранить и в интернете. Обычно для этого используют один из двух сервисов:
